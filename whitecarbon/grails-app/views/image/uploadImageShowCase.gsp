...
<html>
	...
	<body>
		<div id="create-image" class="content scaffold-create" role="main">
			...
			<g:uploadForm action="uploadShowcaseImages" method="post" >
			  <table>
			  <tr class="prop">
			   ...
			   <tr class="prop">
			    <td valign="top" class="name">
			      <label for="payloadThumbnail">Thumbnail File:</label>
			    </td>
			    <td valign="top">
			      <input type="file" id="payloadThumbnail" name="payloadThumbnail"/>
			    </td>
			  </tr>
			   <tr class="prop">
			    <td valign="top" class="name">
